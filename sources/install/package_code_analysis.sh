...
function install_trufflehog() {
    ...
    trufflehog_url=$(curl --location --silent "https://api.github.com/repos/trufflesecurity/trufflehog/releases/latest" | jq .assets.[].browser_download_url | grep "linux_$arch" | grep -o 'https://[^"]*')
